...
## An Introduction
I have been thinking about this complex topic since the excellent talk by [Andrew Eland](https://twitter.com/andreweland) (Technical solutions to keep health data safe and secure &mdash; _slides and video currently unavailable_) at the [Interop Summit](http://www.interopsummit.com/) on the 2nd of March. In this talk he briefly outlined some of the key challenges and potential technical solutions in this area and introduced the concept of Merkle trees. Some of this talk is covered in a later [Blog post](https://deepmind.com/post/trust-confidence-verifiable-data-audit/) published by Google DeepMind.
